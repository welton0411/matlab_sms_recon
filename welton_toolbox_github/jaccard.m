...
%   the Jaccard index.  SIMILARITY is a scalar double in [0,1]. A
%   SIMILARITY of 1 means that the segmentations in BW1 and BW2 are a
%   perfect match.
%
...
%   the first category, the second index for the second category, and so
%   on.
%
%   Notes
%   -----
...
%
%   [3]  The inputs BW, L and C can be 2-D, 3-D or n-D arrays.
%
%   Example 1
%   ---------
