function  NORDIC_wt(file_filter,ARG)
%
...
%ker=4;                        %  if 0, the scaling is automatic to a 11:1 ratio
...
if ~exist('phase_filter_width');  ARG.phase_filter_width=5; else ;  ARG.phase_filter_width= phase_filter_width;  end
